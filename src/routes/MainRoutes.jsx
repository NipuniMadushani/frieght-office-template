...
const AppUserAllCustomers = Loadable(lazy(() => import('views/application/users/account-profile/AllCustomers')));
...
const FrmEditor = Loadable(lazy(() => import('views/forms/plugins/Editor')));
...
// map routing
const AppMap = Loadable(lazy(() => import('views/forms/map')));
